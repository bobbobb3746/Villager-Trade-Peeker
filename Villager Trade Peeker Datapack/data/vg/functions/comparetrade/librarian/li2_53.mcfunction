...
execute if score %bool vg_global matches 0 run tellraw @p [{"text":"57 "},{"text":"emerald","color":"green"},{"text":" and "},{"text":"1 "},{"text":"book","color":"#964B00"},{"text":" -> "},{"text":"1 "},{"text":"enchanted book","color":"aqua"}]
