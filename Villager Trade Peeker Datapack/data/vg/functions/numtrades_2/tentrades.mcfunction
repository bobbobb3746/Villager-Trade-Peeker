...
execute if data entity @s {VillagerData:{profession:"minecraft:armorer"}} run function vg:numtrades_2/tentrades/tentrades_armorer
...
execute if data entity @s {VillagerData:{profession:"minecraft:fletcher"}} run function vg:numtrades_2/tentrades/tentrades_fletcher
