...
execute if data entity @s {VillagerData:{profession:"minecraft:fisherman"}} run function vg:numtrades/twotrades/twotrades_fisherman
...
execute if data entity @s {VillagerData:{profession:"minecraft:librarian"}} run function vg:numtrades_2/twotrades/twotrades_librarian
...
execute if data entity @s {VillagerData:{profession:"minecraft:toolsmith"}} run function vg:numtrades/twotrades/twotrades_toolsmith
execute if data entity @s {VillagerData:{profession:"minecraft:weaponsmith"}} run function vg:numtrades_2/twotrades/twotrades_weaponsmith